            ...
            <Stack mt={5} mb={3} component={'form'} noValidate onSubmit={handleSubmit(handleUpdateOrder)}>
                {
                    orders.length ? (
                                ...
                                <TableBody>
                                    {
                                        orders.map((order, index) => (
                                            <TableRow key={order._id} sx={{ '&:last-child td, &:last-child th': { border: 0 } }}>
                                                ...
                                                <TableCell align="right">
                                                    {
                                                        order.item.map((product) => (
                                                            <Stack mt={2} flexDirection={'row'} alignItems={'center'} columnGap={2} key={product.product._id}>
                                                ...
                                                <TableCell align="right">
                                                    <Stack>
                                                        {/* Check if order.address exists and has elements */}
                        ...
                        <Stack width={is480 ? "auto" : '30rem'} justifyContent={'center'}>
                            <Stack rowGap={'1rem'}>
                                {/* Assuming you have a no orders animation */}
